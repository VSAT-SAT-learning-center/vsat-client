...
function TeacherAccountSetting() {
  ...
  return (
    <PageLayout>
      <div className={cx("teacher-profile-wrapper")}>
        <div className={cx("teacher-profile-container")}>
          <div className={cx("teacher-profile-header")}>
            <div className={cx("teacher-profile-text")}>Profile</div>
            {isEditing ? (

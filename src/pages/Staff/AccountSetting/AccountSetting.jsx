...
function AccountSetting() {
  ...
  return (
    <PageLayout>
      <div className={cx("staff-profile-wrapper")}>
        <div className={cx("staff-profile-container")}>
          <div className={cx("staff-profile-header")}>
            <div className={cx("staff-profile-text")}>Profile</div>
            {isEditing ? (
          ...
          <div className={cx("staff-profile-content")}>

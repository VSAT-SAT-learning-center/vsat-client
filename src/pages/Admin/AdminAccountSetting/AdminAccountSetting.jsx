...
function AdminAccountSetting() {
  ...
  return (
    <PageLayout>
      <div className={cx("admin-profile-wrapper")}>
        <div className={cx("admin-profile-container")}>
          <div className={cx("admin-profile-header")}>
            <div className={cx("admin-profile-text")}>Profile</div>
            {isEditing ? (
          ...
          <div className={cx("admin-profile-content")}>

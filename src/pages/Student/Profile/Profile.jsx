...
function Profile() {
  ...
  return (
    <LearningLayout>
      <div className={cx("student-profile-wrapper")}>
        <div className={cx("student-profile-container")}>
          <div className={cx("student-profile-header")}>
            <div className={cx("student-profile-text")}>Profile</div>
            {isEditing ? (
          ...
          <div className={cx("student-profile-content")}>

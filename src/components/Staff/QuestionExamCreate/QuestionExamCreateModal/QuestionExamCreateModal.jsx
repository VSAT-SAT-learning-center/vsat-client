...
function QuestionExamCreateModal({ setIsShowCreatQuestionModal }) {
  ...
  return (
    <>
      {isShowQuestionPreview && <QuestionExamCreatePreview questionPreviewData={questionPreviewData} setIsShowQuestionPreview={setIsShowQuestionPreview} setIsShowCreatQuestionModal={setIsShowCreatQuestionModal}/>}
      <div className={cx("question-create-modal-wrapper")}>
        <div className={cx("question-create-modal-container")}>
          <div className={cx("question-create-modal-header")}>
            ...
            <div className={cx("question-close")} onClick={() => setIsShowCreatQuestionModal(false)}>
          ...
          <div className={cx("question-create-modal-footer")}>
            <button className={cx("cancel-btn")} onClick={() => setIsShowCreatQuestionModal(false)}>Cancel</button>

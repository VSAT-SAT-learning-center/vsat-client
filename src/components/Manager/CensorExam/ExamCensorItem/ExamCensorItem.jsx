...
import styles from "./ExamCensorItem.module.scss";
const cx = classNames.bind(styles);

function ExamCensorItem({ exam, index, setExamCensorData, setIsShowExamCensorView }) {
